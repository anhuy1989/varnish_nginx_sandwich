...
if (req.url ~ "^(/fi_se/|/ca_fr/|/media/|/skin/|/se/|/fr/|/fi/|/dk/|/js/|/ca/|/de/|/uk/|/stores/|/)(?:(?:index|litespeed)\.php/)?") {
    set req.http.X-Turpentine-Secret-Handshake = "1";
    if (req.url ~ "^(/fi_se/|/ca_fr/|/media/|/skin/|/se/|/fr/|/fi/|/dk/|/js/|/ca/|/de/|/uk/|/stores/|/)(?:(?:index|litespeed)\.php/)?admin/botbackend") {
...
if (req.url ~ "^(/fi_se/|/ca_fr/|/media/|/skin/|/se/|/fr/|/fi/|/dk/|/js/|/ca/|/de/|/uk/|/stores/|/)(?:(?:index|litespeed)\.php/)?(?:admin/botbackend|api|cron\.php)" ||
...
sub vcl_backend_response {
    ...
    if (bereq.url ~ "^(/fi_se/|/ca_fr/|/media/|/skin/|/se/|/fr/|/fi/|/dk/|/js/|/ca/|/de/|/uk/|/stores/|/)(?:(?:index|litespeed)\.php/)?") {
